...
test-parallel-circle:
	mkdir -p  $(tr)
	DISABLE_CONTRACTS=1 	NODE_TOTAL=$(CIRCLE_NODE_TOTAL) 	NODE_INDEX=$(CIRCLE_NODE_INDEX) 	nosetests $(coverage) $(xunitmp) latex_gen_tests  -v  $(parallel)
...
# sigil 3cfd0d4a1e0e0a94c5386632e6b61cb5
