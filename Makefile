...
upload:
	...
	aido-check-tagged
	aido-check-need-upload --package latex-gen-z7 make upload-do
...
cover_packages=latex_gen_tests,latex_gen.tests.demos,latex_gen,latex_gen.tests
...
# sigil f20e187f70b526bab8ed1bb81803749b
